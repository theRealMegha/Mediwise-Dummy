...
urlpatterns = [
    ...
    path('doctor/patient/<int:patient_id>/prescribe/', views.add_prescription_direct, name='add_prescription_direct'),
    path('doctor/patient/<int:patient_id>/lab-test/', views.add_lab_test_direct, name='add_lab_test_direct'),
