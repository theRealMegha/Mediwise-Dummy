...
urlpatterns = [
    ...
    path('patient/prescription-medicines-all-pharmacies/', views.prescription_medicines_all_pharmacies, name='prescription_medicines_all_pharmacies'),
    ...
    # path('patient/cart/course_duration/', views.update_cart_course_duration, name='update_cart_course_duration'),  # Removed: course_duration is no longer used
    ...
    path('doctor/patient/<int:patient_id>/records/', views.doctor_view_patient_records, name='doctor_view_patient_records'),  # View function not implemented
    path('patient_orders/', views.patient_orders, name='patient_orders'),
    path('patient/order/<int:order_id>/details/', views.order_details_ajax, name='order_details_ajax'),  # View function not implemented
    ...
    path('patient/order/<int:order_id>/review/', views.submit_order_review, name='submit_order_review'),
    ...
    path('api/doctor/patient/<int:patient_id>/records/', views.doctor_patient_records_api, name='doctor_patient_records_api'),
    path('doctor/prescription/add/', views.add_prescription, name='add_prescription'),
    path('doctor/patient/<int:patient_id>/lab-test/add/', views.add_lab_test, name='add_lab_test'),
    path('doctor/prescription/<int:prescription_id>/details/', views.prescription_details, name='prescription_details'),
    path('doctor/ratings/', views.doctor_ratings_feedback, name='doctor_ratings_feedback'),
    path('api/patient/<int:patient_id>/appointments/', views.get_patient_appointments_api, name='get_patient_appointments_api'),
    path('api/patient/<int:patient_id>/prescriptions/', views.get_patient_prescriptions_api, name='get_patient_prescriptions_api'),
    path('api/patient/<int:patient_id>/lab-tests/', views.get_patient_lab_tests_api, name='get_patient_lab_tests_api'),
    path('pharmacist/dashboard/', views.pharmacist_dashboard, name='pharmacist_dashboard'),
    path('pharmacist/notifications/', views.pharmacist_notifications, name='pharmacist_notifications'),  # View function not implemented
    path('pharmacist/earnings/', views.pharmacist_earnings, name='pharmacist_earnings'),
    ...
    # API endpoints for medical conditions and operations
    path('api/add_medical_condition/', views.add_medical_condition, name='add_medical_condition'),
    path('api/add_past_operation/', views.add_past_operation, name='add_past_operation'),
        
    path('admin_patients/', views.manage_patients, name='manage_patients'),
    path('admin_pharmacies/', views.manage_pharmacies, name='manage_pharmacies'),
    path('admin_pharmacy/<int:pharmacist_id>/details/', views.pharmacy_details, name='pharmacy_details'),
    ...
    path('admin_orders/pdf/', views.export_orders_pdf, name='export_orders_pdf'),
